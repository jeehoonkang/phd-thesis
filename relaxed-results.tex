...
The {Coq} development and all proof outlines are available at~\cite{appendix}.
...
%\end{tabbing} 
{\begin{tabbing}
\hspace{3.8cm}\= \hspace{2.5cm}\=\kill
...
The set of reorderable pairs in our model contains all pairs that are intended to be reorderable in the C++ 
...
We observe that promise re-certification is necessary for the proofs of \cref{thm:drfpf,thm:drfra}:
