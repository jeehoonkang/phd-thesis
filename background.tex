...
technique (\Cref{sec:background:correctness}).  To flesh out the details on formal semantics and
...
\jeehoon{The concrete model also invalidates dead allocation elimination optimizations.  It's said
  in intptrcast intro.  Connect it to the logical memory model's advantages.}
