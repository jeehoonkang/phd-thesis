...
and dead allocation elimination.  Second, the ISO C18 standard says that \code{malloc} returns zero
in case of out of memory~\cite[\S7.22.3p1]{c18}, instead of allowing no behaviors.  The ISO C18
...
valid pointer in the target.  For this reason, we leave defining a more proper semantics of out of
