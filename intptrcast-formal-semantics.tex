...
\texttt{malloc} returns zero in case of out of memory [\S7.22.3 paragraph~1] \jeehoon{check it},
...
%% In C11 Standard~\cite{iso2011iec}, \texttt{malloc} returns $0$ when out of memory (7.22.3
