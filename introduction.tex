...
(\Cref{chap:intptrcast}), the semantics of relaxed-memory concurrency (\Cref{chap:promising}), and
lightweight verification of separate compilation (\Cref{chap:sepcomp}).  This dissertation concludes
with \Cref{chap:epilogue}, which summarizes our contributions and their impacts
