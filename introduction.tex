...
\jeehoon{Use Juneyoung's example.}
...
\jeehoon{Give structures: feature's importance, prior work, solution, impact.}
...
\jeehoon{discuss Crellvm: supporting sophisticated optimizations in mainstream compilers.}
