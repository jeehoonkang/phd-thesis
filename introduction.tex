...
\subsection{The Problem: Optimization as a Threat to Compiler Reliability}
...
which are difficult to fix because it is unclear which optimizations are to blame.
...
For example, \Cref{fig:introduction:bug} presents a GCC miscompilation bug due to conflicts among
multiple optimizations.\footnote{We reported this miscompilation bug as a comment in
