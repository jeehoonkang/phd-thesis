...
%
\begin{itemize}
\item In \Cref{chap:intptrcast}, we propose a formal semantics of \textbf{casts between integers and
...
\item In \Cref{chap:promising}, we propose a formal semantics of \textbf{relaxed-memory
...
\item In \Cref{chap:sepcomp}, we propose a lightweight verification technique for verifying
