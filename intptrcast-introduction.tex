...
\Cref{fig:introduction:bug}, which is turning off some controversial, too aggressive alias analysis.
...
\item A proposal to fix to GCC bug presented in \Cref{fig:introduction:bug}. \jeehoon{mention it in
    the body.}
