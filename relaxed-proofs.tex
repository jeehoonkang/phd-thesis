...
explain our proof technique for proving the soundness of transformations in the presence of
certification (\Cref{sec:relaxed:proofs:simulation}).  Then we present the proofs of DRF-RA
...
\subsection{Simulation Proof in the Presence of Certification}
